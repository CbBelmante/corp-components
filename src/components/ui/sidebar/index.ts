...
// ============== CORP SIDEBAR VARIANTS (CVA) ==============

/**
 * CVA do CorpSidebar - background vem do theme
 */
export const corpSidebarVariants = cva([
  // Base
